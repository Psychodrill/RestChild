...
$(function () {
    ...
    $('#Child-DocumentTypeId').change(function (e) {
        var birthCertId = '22';
        var passport = '50001';
    ...
    var tradeUnionSetStateView = function () {
    ...
    $('#IsParentUnionist, #IsParentUnionist-False').change(function (e) {
        var $e = $('#IsParentUnionist');
        if ($e.prop('checked')) {
    ...
    $('#IsRelativeUnionist, #IsRelativeUnionist-False').change(function (e) {
    ...
    $('#IsScoolNotPresent').change(function (e) {
    ...
    $('#IsTradeUnionOrgNotPresent').change(function (e) {
        if ($('#IsTradeUnionOrgNotPresent').prop('checked')) {
            $('#divOtherTradeUnionOrgName').removeClass('hidden');
    ...
    function validateTabsForms(item) {
        ...
        var mos = $("#cbAddress").prop("checked");
    ...
    function editPerson(item, callback) {
        ...
        $('#personSaveBtn').click(function () {
            ...
            var pf = function (str) { if (str == null)
                return 0; return parseFloat(str.replace(',', '.')); };
    ...
    function bindDataToRow($row, item) {
        ...
        $row.find('.hdn-json').val(JSON.stringify(item));
    }
    ...
    clearTradeUnionChildForm = function (dataModificator) {
        var $row = $(templateFn(-key));
