...
function inputMaskConfig(scope) {
	...
	$(scope.find('.input-mask-email')).inputmask({
		mask: "*{1,200}[.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}][.*{1,200}]@*{1,200}[.*{2,6}][.*{1,2}]",
		greedy: false,
		placeholder: " ",
		clearIncomplete: true,
    ...
    $(scope.find('.input-mask-age')).inputmask("99");
	...
	$(scope.find('.procent')).inputmask('decimal', { allowMinus: false, rightAlign: false, digits: 2, radixPoint: ',', min: 0, max: 100 }).focusout((e) => {
