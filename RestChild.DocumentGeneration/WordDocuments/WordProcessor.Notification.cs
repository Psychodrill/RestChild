            ...
            using (var ms = new MemoryStream())
            {
                using (var wordDocument = WordprocessingDocument.Create(ms, WordprocessingDocumentType.Document))
                {
                    ...
                    if (benefits.Count() >= 0)
                    {
                        ...
                        docs.Add("документ, удостоверяющий личность ребенка;");//11
                        ...
                        foreach (BenefitType benefit in benefits)
                        {
                            ...
                            if (benefit.Id ==48||benefit.Id==67)
                            {
                                docs.Remove("документ, удостоверяющий личность ребенка;");
                                ...
                                docs.Add("документ, подтверждающий место жительства лица из числа детей-сирот и детей, оставшихся без попечения родителей, в городе Москве;");
                                docs.Add("документ, подтверждающий отнесение лица из числа детей-сирот и детей, оставшихся без попечения родителей, к категории лиц из числа детей-сирот и детей, оставшихся без попечения родителей.");
