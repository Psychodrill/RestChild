...
namespace RestChild.Mobile.DAL
{
    ...
    ///     работа данными
    /// </summary>
    public class MobileUnitOfWork : IUnitOfWorkMobile
    {
        private const string ConnectionStringName = "RestChild.Mobile";

        private static readonly string[] NotChangeLastUpdateTick = new string[0];
        ...
        public async Task<T> AddEntityAsync<T>(T entity, CancellationToken token, bool saveChanges = true)
            where T : class, IEntityBase
        {
