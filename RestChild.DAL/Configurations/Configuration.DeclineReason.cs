        ...
        private static void DeclineReason(Context context)
        {
            ...
            context.DeclineReason.AddOrUpdate(a => a.Id,
                ...
                new DeclineReason
                {
                    ...
                    IsActive = false,
                    Name =
                        "пункт 9.1.4(1) Порядка: \"Отсутствие подтверждения получения ежемесячного пособия в соответствии с Законом города Москвы от 3 ноября 2004 г. № 67 \"О ежемесячном пособии на ребёнка\" на детей, находящихся в трудной жизненной ситуации и указанных в пунктах 3.1.5-3.1.13 настоящего Порядка\".",
                    IsManual = true,
                    FirstStage = true,
                    SecondStage = true,
                    StatusId = (long) StatusEnum.Reject
                ...
                new DeclineReason
                {
                    ...
                    IsActive = true,
                    Name =
                        "пункт 9.1.7 Порядка: \"Неучастие заявителя во втором этапе заявочной кампании в целях организации отдыха и оздоровления, предусматривающем необходимость выбора заявителем конкретной организации отдыха и оздоровления.\"",
                    IsManual = true,
                    FirstStage = true,
                    SecondStage = true,
                    StatusId = (long) StatusEnum.Reject
