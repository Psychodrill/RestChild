...
Для подтверждения сведений, указанных в заявлении, Вам необходимо явиться в течение пяти рабочих дней с момента получения этого уведомления по адресу: г. Москва, переулок Огородная слобода д.9 стр.1 с 8:00 до 20:00 ежедневно.
...
в соответствии с ",
                ...
                }, new Status
                {
                    ...
                    MpguComment =
                        "Услуга оказана. Путевка носит информационный характер. Путевку на отдых и оздоровление вы можете распечатать самостоятельно из личного кабинета или получить в бумажном виде в ГАУК «Мосгортур» по адресу: г. Москва, переулок Огородная слобода д.9 стр.1 с 8:00 до 20:00 ежедневно.",
