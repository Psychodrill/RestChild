// File:    PupilGroupVacationPeriod.cs
// Purpose: Definition of Class PupilGroupVacationPeriod
...
namespace RestChild.Domain
{
   ...
   /// <summary>
   /// Каникулярный период группы (потребности)
   /// </summary>
   [Serializable]
   [DataContract(Name = "pupilGroupVacationPeriod")]
   public partial class PupilGroupVacationPeriod : IEntityBase
   {
      ...
      /// </summary>
      [InverseProperty("VacationPeriod")]
