// File:    TypeOfTransportInRequest.cs
// Purpose: Definition of Class TypeOfTransportInRequest
...
namespace RestChild.Domain
{
   ...
   /// <summary>
   /// Вид транспорта в рамках заявления
   /// </summary>
   [Serializable]
   [DataContract(Name = "typeOfTransportInRequest")]
   public partial class TypeOfTransportInRequest : IEntityBase
   {
