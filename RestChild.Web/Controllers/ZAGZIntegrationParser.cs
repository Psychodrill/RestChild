...
namespace RestChild.Web.Controllers.ZAGZIntegration
{
   /// <summary>
   /// загрузка данных из ЗАГС
   /// </summary>
   public static class ImportZagz2018
   {
      #region Templates 

      internal const string responseErrorTemplate = @"<?xml version=""1.0"" encoding=""utf-16""?>
<CoordinateStatusMessage xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
	...
	<StatusMessage>
      ...
      internal const string responseSuccessTemplate = @"<?xml version=""1.0"" encoding=""utf-16""?>
<CoordinateStatusMessage xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
	<ServiceHeader>
		<FromOrgCode xmlns=""http://asguf.mos.ru/rkis_gu/coordinate/v5/"">1111</FromOrgCode>
		<ToOrgCode xmlns=""http://asguf.mos.ru/rkis_gu/coordinate/v5/"">2064</ToOrgCode>
	...
	<StatusMessage>
      ...
      internal static List<List<string>> GetDataTableFromExcel(HttpPostedFileBase file, bool hasHeader = true)
      {
      ...
      internal static List<List<string>> GetDataTableFromExcel(byte[] file, bool hasHeader = true)
      {
         return GetDataTableFromExcel(file, hasHeader ? 2 : 1);
      }

      internal static List<List<string>> GetDataTableFromExcel(byte[] file, int startRow)
      {
         using (var pck = new OfficeOpenXml.ExcelPackage())
         {
      ...
      /// импорт
      /// </summary>
      public static void ImportZagzFromExcel(HttpPostedFileBase file)
      {
         using (var uv = new UnitOfWork())
         {
            Console.WriteLine();
            var table = GetDataTableFromExcel(file);
