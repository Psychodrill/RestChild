                        ...
                        if (vm.SameAttendantSnils.Any() || vm.SameAttendants.Any())
                        {
                            ...
                            if (vm.SameAttendants.Any())
                            {
                                ...
                                if (entity.TypeOfRestId == (long)TypeOfRestEnum.RestWithParentsPoor)
                                    ...
                                    uts.ErrorText = $@"Заявление является повторным. На указанного(их) в заявлении сопровождающее(их) лицо(лиц) ({msg}) уже подано заявление о предоставлении бесплатной путевки для отдыха и оздоровления.";
                                if (entity.TypeOfRestId == (long)TypeOfRestEnum.MoneyOn3To7)
                                    ...
                                    uts.ErrorText = $@"Заявление является повторным. На указанного(их) в заявлении сопровождающее(их) лицо(лиц) ({msg}) уже подано заявление о предоставлении сертификата на отдых и оздоровление.";
                            }
