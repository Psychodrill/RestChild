function validateAttendant($form) {
    var foreignPassportId = '60005';
    var isValid = true;
    var required = ['.lastName', '.firstName', '.datebirth', 'select.document-type', '.document-number', '.document-date-issue', '.document-subject-issue', '.position', '.telephone'];
...
//# sourceMappingURL=AttendantDialogValidation.js.map