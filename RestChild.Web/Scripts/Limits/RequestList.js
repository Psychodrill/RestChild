$(function () {
                        ...
                        success: function (result) {
                            if (result) {
                                BootstrapDialog.show({
                                    title: 'Ошибка',
                                    message: result,
                                    buttons: [{ label: 'Закрыть', action: function (dialogItself) { dialogItself.close(); } }]
                                });
                            }
                            else {
                                $('#mainForm').submit();
    ...
    $('#appendDialogButton').click(function () {
                            ...
                            success: function (result) {
                                ...
                                if (result.isError) {
                                    ...
                                    BootstrapDialog.show({
                                        ...
                                        buttons: [
                                            { label: 'Закрыть', action: function (dialogItself) { dialogItself.close(); } }
                                        ]
                                    });
                                }
                                else {
