...
$(function () {
    $(document).on('change', 'select.not-need-ticket-select', function (e) {
        var $target = $(e.target);
        var tr = $target.closest('tr');
    ...
    $(document).on('change', 'input.not-need-ticket', function (e) {
...
//# sourceMappingURL=NotNeedTicketSelect.js.map