...
$(() => {
	...
	$('#copyServicesBtn').click(() => {
		...
		var servicesIds = [];
		$('#serviceTableCopyServices input[type=checkbox]').each((i, e) => {
			var $e = $(e);
