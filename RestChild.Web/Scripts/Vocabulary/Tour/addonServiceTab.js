...
$(function () {
    ...
    function initSelectService(control) {
        control.select2({
            ...
            ajax: {
                ...
                data: function (term, page, e) {
                    var hotelsId = [];
                    $('.main-hotelId').each(function (i, e) {
    ...
    function processTable(parent, newName) {
        ...
        if ($rows.length > 0) {
            $rows.each(function (num, val) {
                var $td = $(val).children('td:first');
                $td.children('input').each(function (inputNum, input) {
                ...
                rowsPriceTable.each(function (trNum, tr) {
                    $(tr).children('input').each(function (inputNum, input) {
    ...
    $('#serviceDialog').find('.cbxIsGroup').change(function (e) {
    ...
    function prepareDialogPriceRow(template) {
        ...
        template.find('.remove-serviceprice-btn').click(function (e) {
    ...
    function editService(e) {
        ...
        items.each(function (i, e) {
            ...
            clasessPricess.forEach(function (v) {
                var item = $r.find('.' + v);
    ...
    $('#serviceDialog').find('.addprice').click(function () {
        var template = $($('#servicePriceRowTemplate').html());
    ...
    function getTypeOfRooms() {
        var typeOfRooms = [];
        var ids = {};
        $('.fond-TypeOfRoomsId').each(function (i, e) {
            var $element = $(e);
...
//# sourceMappingURL=addonServiceTab.js.map